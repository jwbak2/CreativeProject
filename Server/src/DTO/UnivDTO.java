...
public class UnivDTO {
    ...
    private String univLogoImagePath;
    ...
    public String getUnivLogoImagePath() {
        return this.univLogoImagePath;
    }

    public void setUnivLogoImagePath(String univLogoImagePath) {
        this.univLogoImagePath = univLogoImagePath;
    }
