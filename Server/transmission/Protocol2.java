...
public class Protocol2 {
	...
	private Object packet;	// DTO, String, ArrayList, etc...


	public Protocol2() { // 인수가 정해지지 않은 경우의 생성자
	...
	public Protocol2(int protocolType, int protocolCode) {
	...
	public Protocol2(int protocolType, int protocolCode, Object packet) {
		this.protocolType = protocolType;
		this.protocolCode = protocolCode;
