...
public class Protocol123 implements Serializable {
    ...
    public static final int PT_FAIL_UNIV_LIST = 0x02;				// 학교 리스트 요청 실패
    public static final int PT_FAIL_UNIV_CP = 0x03;					// 학교 상세정보 비교 요청(CP = compare) 실패
    public static final int PT_FAIL_UNIV_RATING = 0x04;             // 학교 평가 페이지에서 평가 내용 등록 실패
    ...
    public Protocol123() { // 인수가 정해지지 않은 경우의 생성자
    ...
    public Protocol123(int protocolType, int protocolCode) {
    ...
    public Protocol123(int protocolType, int protocolCode, Object body) {
        this.protocolType = protocolType;
        this.protocolCode = protocolCode;
